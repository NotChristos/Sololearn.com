...
class Button(width: Int, height: Int) : Component(width, height) {
    ...
    override fun show() {
        println("Showing a Button") // переопределяем ф-цию из абстрактного класса Component
    }
}
...
class Image(width: Int, height: Int) : Component(width, height) {
    ...
    override fun show() {
        println("Showing an Image") // переопределяем ф-цию из абстрактного класса Component
    }
}
